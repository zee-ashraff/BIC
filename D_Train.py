...
# Prepare input data
classes = os.listdir('C:/Users/zeesh/Desktop/Broadview_Image_Classifier/training_data')
...
img_size = 128
num_channels = 3
train_path = 'C:/Users/zeesh/Desktop/Broadview_Image_Classifier/training_data'
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples / batch_size) == 0:
            ...
            saver.save(session, 'CatDog-model')
